...
# Fixed: Use a standard, valid Gemini model identifier
...
# Stop looping when the validation checker outputs "ok"
robust_blog_planner = LoopAgent(
    ...
    stop_condition=lambda state: state.get("validation_result", "").strip().lower() == "ok",
    max_iterations=3,
)
...
# Expose planner/writer as tools
